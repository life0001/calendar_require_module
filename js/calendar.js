...
define(function () {
    ...
    Calendar.prototype = {
         ...
         * 获得所需日期
         */
        _getDate: function (date, eventMonth) {
            var odate = new Date(),
         ...
         * 获取 本月 或 目标月 1号之前的天数
         */
        getPreMonthDays: function (eDay, data, id) {
         ...
         * 获取 本月 或 目标月 天数
         */
        getCurMonthDays: function (eDay, data) {
         ...
         * 获取 本月 或 目标月 之后一月天数
         */
        getNextMonthDays: function (eDay, $outputId, id) {
         ...
         * 获取点击后的日期
         */
        getDate: function (that, $outputId, id) {
         ...
         * 获得节日信息
         */
        getHolidayInfo: function (month, day) {
            switch (month) {
                case 1:
                    if (day == 1) {
                        return 'holiday">元旦';
